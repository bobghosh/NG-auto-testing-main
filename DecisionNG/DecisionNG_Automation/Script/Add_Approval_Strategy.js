...
{   
  ...
  {          
    ...
    let MessageforAll = Aliases.browser.pageSapiensDecision2.FindElement("//dcn-approval-strategy//p-table//span]");
  ...
  {
    let MessageforAny = Aliases.browser.pageSapiensDecision2.FindElement("//dcn-approval-strategy//p-table//span]");
  ...
  for(let i = 0; i < User_array.length; i++)
  {
    ...
    if(Aliases.browser.pageSapiensDecision2.FindElement("//*[@ng-reflect-label='Approval Strategy']//input").Text.trim().toUpperCase() == AprrovalStrategy.toUpperCase())
    {
    ...
    if(Aliases.browser.pageSapiensDecision2.FindElement("//*[@ng-reflect-label='Import Approval Strategy']//input").Text.trim().toUpperCase() == ImportApprovalStrategy.toUpperCase())
    {
