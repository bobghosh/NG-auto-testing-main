...
//  let Month = "Sep"; "Aug" "Jul" "Dec"
  ...
  for(var i = 1; i <=AssetList.length ; i++)
  {
    ...
    if(AssetName == Asset_Name)
    {
      ...
      Aliases.browser.pageSapiensDecision2.FindElement("//*[contains(@class,'ui-table-frozen-view')]//tbody//tr["+i+"]//td[4]//dcn-button-menu").HoverMouse();
      
      Aliases.browser.pageSapiensDecision2.FindElement("//*[contains(@class,'ui-table-frozen-view')]//tbody//tr["+i+"]//td[4]//dcn-button-menu").Click();
...
//      Aliases.browser.pageSapiensDecision.form.buttonOk.ClickButton();
      ...
      let Effective_Date = Aliases.browser.pageSapiensDecision2.FindElement("//*[contains(@class,'ui-table-unfrozen-view')]//tbody//tr["+i+"]//td[4]").textContent;
      
      let Expiration_Date = Aliases.browser.pageSapiensDecision2.FindElement("//*[contains(@class,'ui-table-unfrozen-view')]//tbody//tr["+i+"]//td[5]").textContent;
