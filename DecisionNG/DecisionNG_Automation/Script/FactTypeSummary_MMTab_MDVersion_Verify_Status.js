function VerifyModelDefinitionVersionStatus(ModelDefinitionVersion)
{
        ...
        {          
            ...
            if(ModelDefinition_Version_Text == MD_Version_Values[j])
            {
             ...
             Log.Message(Version_Status)
              ...
              {
                Log.Checkpoint("Model Definition version Status"+MD_Version_Values[j]+" is Draft");
                
              }
              else
              {
                Log.Message("Model Definition version Status"+MD_Version_Values[j]+" is not Draft")
              }
              break;
            }
