function Model_Definition_Freeze_Version()
{
    ...
    for(let i = 1; i <=VersionCount.length; i++)
    {
      ...
      {              
          ...
          Aliases.browser.pageSapiensDecision2.FindElement("//body//div[contains(@style,'display: block')]//ul//span[text()='Freeze']").click() 
          
          //Delay(500);
          
          if(Aliases.browser.pageSapiensDecision2.FindElement("//tbody//tr[" + i +"]//td[2]//i[contains(@class,'icon-frozen')]").Exists == true)
          {
            Log.Message("The Version " + Version + " is Freezed");
